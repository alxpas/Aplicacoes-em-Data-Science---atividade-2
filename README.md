...
3. Crie também uma pequena Interface IDE usando Python e Tkinter, que roda no seu PC e se comunica com o mesmo Banco de Dados no Supabase. Esta interface deve ter as funções de visualizar e consultar dados existentes (apenas isso).  


4. Entregas: (a) código-fonte completo em python; (b) endereço URL e key do Banco de Dados Supabase, para o professor testar.